	  ...
	  <tr>
		...
		<td>
		  ...
		  <iframe id="iframe_t" name="iframe_t" border="0" src="upload.php?action=<?php echo isset($rt['img'])&&!empty($rt['img'])? 'show' : '';?>&ty=baomingimg&files=<?php echo isset($rt['img']) ? $rt['img'] : '';?>" scrolling="no" width="445" frameborder="0" height="25"></iframe>
           ...
           <tr>
		<td class="label">扣率/ T+0:</td>
		<td><textarea name="koulv" id="koulv" style="width: 700px; height: 200px; "><?php echo isset($rt['koulv']) ? $rt['koulv'] : '';?></textarea>
		<script>KE.show({id : 'koulv',cssPath : '<?php echo ADMIN_URL.'/css/edit.css';?>' });</script>
		</td>
	  </tr>
      
      
           <tr>
		<td class="label">手续费分润:</td>
		<td><textarea name="description" id="description" style="width: 700px; height: 200px; "><?php echo isset($rt['description']) ? $rt['description'] : '';?></textarea>
		<script>KE.show({id : 'description',cssPath : '<?php echo ADMIN_URL.'/css/edit.css';?>' });</script>
		</td>
	  </tr>
	  		
	  		           <tr>
		<td class="label">升级奖励:</td>
		<td><textarea name="content" id="content" style="width: 700px; height: 200px; "><?php echo isset($rt['content']) ? $rt['content'] : '';?></textarea>
