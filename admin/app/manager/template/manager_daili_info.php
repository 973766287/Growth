<div class="contentbox">
	<form id="form1" name="form1" method="post" action="">
     <table cellspacing="0" cellpadding="5" width="100%" align="left">
	 	<tr>
			<th colspan="2" align="left"><?php echo $type=='edit' ? '修改' : '添加';?>代理</th>
		</tr>
		<tr>
...
//		}
		...
		$.post('<?php echo $thisurl;?>',{action:'adddailimanmger',pass:pass,uname:uname,groupid:grid,aid:aid},function(data){ 
			removewindow();
			if(data == ""){
