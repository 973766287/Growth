...
<table cellspacing="2" cellpadding="5" width="100%">
		<tr>
			<td class="label" width="15%">当前代理商费率：</td>
			<td>
			<?php echo isset($dq_set['dl_feilv']) ? $dq_set['dl_feilv'] : '0';?>
			</td>
		</tr>
		<tr>
			<td class="label">当前代理商手续费：</td>
			<td>
			<?php echo isset($dq_set['dl_sxf']) ? $dq_set['dl_sxf'] : '0';?>
			  </td>
		</tr>
...
<form id="form1" name="form1" method="post" action="">
     ...
     <table cellspacing="2" cellpadding="5" width="100%">
		<tr>
			<td class="label" width="15%">下级代理商费率：</td>
			<td>
