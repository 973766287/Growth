...
<div class="contentbox">
	 ...
	 <tr>
		<th colspan="6" align="left" style="text-align:left">积分统计</th>
	</tr>
	<tr>
	...
	<td><?php echo $row['points'] > 0 ? '收入:<font color=blue>'.$row['points'].'</font>' : '支出:<font color=red>'.($row['points']).'</font>';?></td>
	<td><?php echo $row['changedesc'];?></td>
	<td><?php echo date('Y-m-d H:i:s',$row['time']);?></td>
	<td><a href="<?php echo ADMIN_URL.'user.php?type=userjifen&id='.$row['cid'];?>" onclick="return confirm('确定删除吗');"><img src="<?php echo $this->img('icon_drop.gif');?>" title="删除" alt="删除" id="<?php echo $row['cid'];?>"/></a></td>
	</tr>
	<?php } ?>
	 </table>
