...
<div class="contentbox">
	...
	<tr><td align="left">
      ...
      <td   align="left">
    	<a href="<?php echo ADMIN_URL.'user.php?type=userrelate_own&id='.$uid;?>&r=9" style="font-size:14px; color:#FF0000">金牌会员</a>
	</td>
      
        <td   align="left">
    	<a href="<?php echo ADMIN_URL.'user.php?type=userrelate_own&id='.$uid;?>&r=10" style="font-size:14px; color:#FF0000">钻石会员</a>
	</td>
      
        <td   align="left">
    	<a href="<?php echo ADMIN_URL.'user.php?type=userrelate_own&id='.$uid;?>&r=11" style="font-size:14px; color:#FF0000">皇冠会员</a>
	</td>
        
        <td   align="left">
    	<a href="<?php echo ADMIN_URL.'user.php?type=userrelate_own&id='.$uid;?>&r=12" style="font-size:14px; color:#FF0000">投资合伙人</a>
	</td>
