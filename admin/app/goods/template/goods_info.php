...
<input type="hidden" name="supplier_id" value="<? echo $rt['supplier_id'];?>" />
 <h2 class="nav">
...
<!--  <a class="other" onclick="show_hide('3'); return false;">商品属性</a>  -->
 ...
 <div class="menu_content">
     ...
     <? if ($rt['supplier_id'] || $_SESSION['supplier_id']){?>
     <tr>
     <td class="label">审核状态：</td>
     <td>
     <input type="radio"  name="is_check" id="is_check" value="1" <? if($rt['is_check'] == 1){?>checked="checked"<? }?>/>审核通过
      <input type="radio"  name="is_check"  id="is_check" value="0" <? if($rt['is_check'] == 0){?>checked="checked"<? }?>/>未审核
       <input type="radio"  name="is_check" id="is_check" value="-1" <? if($rt['is_check'] == -1){?>checked="checked"<? }?>/>审核未通过
     </td>
     </tr>
     ...
     <tr>
      ...
      <td>
      <textarea name="shenhe"  rows="4" cols="50"><? echo $rt['shenhe'];?></textarea>
      </td>
     <? }?>
     </tr>
	  <tr>
	 ...
	 <table cellspacing="2" cellpadding="5" width="100%" id="tab2" class="tab">
		<tr>
			...
			<label><input name="is_hot" value="1" type="checkbox" <?php echo isset($rt['is_hot'])&&$rt['is_hot']==1 ? 'checked="checked"' : '';?>>热销</label>
                        <label><input name="is_prize" value="1" type="checkbox" <?php echo isset($rt['is_prize'])&&$rt['is_prize']==1 ? 'checked="checked"' : '';?>>奖品</label>
			</td>
        </tr>
		   <tr>
