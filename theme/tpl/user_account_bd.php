<div id="wrap">
    ...
    <div class="m_right"  >
		<h2 class="con_title">绑定账号</h2>
    	<div class="updatepass">
				 <form name="USERINFO" id="USERINFO" action="" method="post">
					<table width="500" border="0" cellpadding="0" cellspacing="0">
					  <tr>
						<td align="right" width="100">绑定：</td>
						<td><input type="radio" name="bdtype" id="bdtyp1" value="1">保留微信账号 
                                                    <input type="radio" name="bdtype" id="bdtyp2" value="2">保留平台账号 
                                                  </td>
					  </tr>
					  <tr>
...
function ajax_postmoney(){
	...
	if(confirm('确认信息无误提款吗')){
		...
		$.post('<?php echo SITE_URL;?>user.php',{action:'ajax_account_bd',money:money,id:'<?php echo $rts['id'];?>'},function(data){ 
