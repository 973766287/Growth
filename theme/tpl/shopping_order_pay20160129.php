...
<div id="main" style="width:1020px; margin:0px auto; background-color:#FFF;">
	...
	<div class="goodslist">
		...
		<tr>
			...
			<p style="padding-top:5px; padding-left:10px; font-size:14px;">订单折扣总金额：<font color="#FF0000"><b>￥<?php echo $rt['orderinfo']['order_amount'];?></b>+￥<b><?php echo $rt['orderinfo']['shipping_fee'];?></b>(邮费)=￥<?php echo format_price($rt['orderinfo']['order_amount']+$rt['orderinfo']['shipping_fee']);?></font></p>
		...
		<?php if($rt['orderinfo']['pay_status'] !='1'){?>
		<div>
			<a href="<?php echo SITE_URL.'mycart.php?type=fastpay2&oid='.$rt['orderinfo']['order_id'];?>" class="btn-buy button ui-btn ui-btn-text-only"><span class="ui-btn-text">立即支付</span></a>
