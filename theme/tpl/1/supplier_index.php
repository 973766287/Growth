        ...
        <div class="jRating">
          <div id="float_box"  style="display: none;"  class="jRatingTotal">
           <ul class="shopTolal">   
              ...
              <li> <span>所在地区：</span><span><? echo $s_info['province'];?> <? echo $s_info['city'];?> <? echo $s_info['district'];?></span></li>
...
<div class="store_box">
	<div class="store_box_top">
		...
		<div class="store_box_top_box">
           ...
           <? if (!empty($tj)){?>
<div class="fn-clear user_e990_20004_5-493262" style="margin-bottom:0px;margin: 0px auto;width: 1210px;" >
                    ...
                    <div class="j-module"> 
                      ...
                      <div style="margin: 0px auto;" class="items">
                        <div class="items-inner">
                          ...
                          <? if ($_k < 6){?>
                            <div class="item item<? echo $_k+1;?> user_bgcolor_3 user_border_3"> 
...
<? }?>
 ...
 <? if($rx){?>       
	<div class="pro-list-oper" id="J-pro-list-fix">
		<div class="stitle" style="font-size: 22px;height: 60px;line-height: 60px;color: #fff;">热销推荐</div>
	...
	<div class="store_box_img">
		<ul>
			...
			<div class="store_box_img_tp">
				<a href="<?php echo SITE_URL . 'product.php?id=' . $bestgoods['goods_id']; ?>" target="_blank" ><img src="<? echo $bestgoods['goods_img'];?>" class="" alt="<? echo $bestgoods['goods_name']?>" height="232" width="232"></a>
			</div>
			<div class="store_box_img_bt">
				<div class="store_box_img_bt_tlt">
					<h3><a href="<?php echo SITE_URL . 'product.php?id=' . $bestgoods['goods_id']; ?>" target="_blank"><em></em><? echo $bestgoods['goods_name']?></a></h3>
					<div class="store_box_img_bt_bot">
						<a href="<?php echo SITE_URL . 'product.php?id=' . $bestgoods['goods_id']; ?>" target="_blank"><span class="tb_r2"></span></a>
         促销价 
						<strong><i>￥</i>
                        <? if ($bestgoods['promote_price'] >0){?>
          								<? echo $bestgoods['promote_price'];?>
          							<? }else{?>
          							<? echo $bestgoods['pifa_price'];?>
          							<? }?>
                        </strong><em><? echo round(($bestgoods['pifa_price']/$bestgoods['shop_price']),2)*10;?>折</em><br>
         原价：
						<span class="tb_c">￥<? echo $bestgoods['shop_price'];?></span> 国内参考价￥<? echo $bestgoods['market_price'];?>
					</div>
				</div>
			</div>
			</li>
    ...
    <? }?>
     ...
     <? if($new){?>
   <div class="pro-list-oper" id="J-pro-list-fix">
		<div class="stitle" style="font-size: 22px;height: 60px;line-height: 60px;color: #fff;">新品推荐</div>
		<!-- 翻页导航工具栏 author:eason.chen@vipshop.com -->
