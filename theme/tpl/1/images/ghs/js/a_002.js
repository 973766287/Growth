...
(function(a) {
	a.fn.jdSlide = function(k) {
		...
		var n = p.pics.length;
		var o = function() {
			var q = "<ul style='position:absolute;top:0;left:0;'><li><a href='../../../../dianpu2/images/ghs/js/" + p.pics[0].href + "' target='_blank'><img src='../../../../dianpu2/images/ghs/js/" + p.pics[0].src + "' width='" + p.width + "' height='" + p.height + "' /></a></li></ul>";
			i.css({
				position: "relative"
			}).html(q);
			a(function() {
		...
		var j = function() {
			...
			for (var t = 0; t < n; t++) {
				...
				case "string":
					...
					break;
				case "image":
					q = "<img src='../../../../dianpu2/images/ghs/js/" + p.pics[t].breviary + "' />";
				default:
					break;
				}
				s.push("<span class='");
				s.push(r);
				s.push("'><a href='../../../../dianpu2/images/ghs/js/");
		...
		var c = function() {
			var q = [];
			for (var r = 1; r < n; r++) {
				q.push("<li><a href='../../../../dianpu2/images/ghs/js/");
				q.push(p.pics[r].href);
				q.push("' target='_blank'><img src='../../../../dianpu2/images/ghs/js/");
				q.push(p.pics[r].src);
				q.push("' width='");
				q.push(p.width);
				q.push("' height='");
