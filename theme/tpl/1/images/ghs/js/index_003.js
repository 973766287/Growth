        ...
        if (event.keyCode == 13) {
            ...
            function(data) {
                if (data.done) {
                    ...
                    var html = '';
                    for (var i = 0; i < len; i++) {
                        html += "<li><a href='../../../../dianpu2/images/ghs/js/" + TAOCZ_URL + "/index.php?app=search.search&keywords=" + retval[i] + "'>" + retval[i] + "</a></li>"
...
function setHotKeywords() {
    ...
    for (var i = 0; i < hotKeywords.length; i++) {
        if (hotKeywords[i] != 'false') {
            html += '<dd><a href="../../../../dianpu2/images/ghs/js/' + TAOCZ_URL + '/search.html?keywords=' + hotKeywords[i] + '">' + hotKeywords[i] + '</a></dd>'
