		    ...
		    <div class="index_main1_left fl">
                ...
                <?php foreach ($qx as $k => $row) { ?>
				    ...
				    <div class="index_main1_left_bottom_main fl">
						...
						<div class="index_main1_left_bottom_main3"><?php echo $row['sort_desc']?mb_substr($row['sort_desc'],0,12,'utf-8'):mb_substr(trim($row['goods_name']),0,12,'utf-8'); ?></div>
		...
		<div class="index_main3">
		    <div class="index_main31">
			    <div class="index_main31_top">
				    <div class="index_main31_top_left fl l">干果专区</div>
			...
			<div class="index_main31">
			    <div class="index_main32_top">
				    <div class="index_main32_top_left fl l">潮服专区</div>
                                    <div class="index_main31_top_right fr"><a href="<?php echo SITE_URL;?>catalog.php?cid=591"><img src="images/36.jpg" width="57" height="26" /></a></div>
				</div>
				<div class="index_main31_bottom">
			...
			<div class="index_main31">
			    <div class="index_main34_top">
				    <div class="index_main34_top_left fl l">丝袜专区</div>
