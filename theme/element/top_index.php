				...
				<ul class="pullDownList">
                  ...
                  <?php foreach($catList as $_k=>$_v){?>
                    ...
                    <li>
						...
						<i class="listi<? echo $_v['i'];?>"></i>
					<a href="catalog.php?cid=<?php echo $_v['id'];?>" target="_blank"><?php echo $_v['name'];?></a>
						<span></span>
					</li>
                       <?php } ?>
              ...
              <?php foreach($catList as $_k=>$_v){?>
				<div class="yMenuListConin">
					<div class="yMenuLCinList">
						<h3><a href="catalog.php?cid=<?php echo $_v['id'];?>" target="_blank" class="yListName"><?php echo $_v['name'];?></a><a href="catalog.php?cid=<?php echo $_v['id'];?>" target="_blank" class="yListMore">更多 ></a></h3>
						<p>
                           <?php 
                              if(!empty($_v['cat_id'])){
                              foreach($_v['cat_id'] as $_k1=>$_v1){ ?>
                              <a href="catalog.php?cid=<?php echo $_v1['id'];?>"  target="_blank">  <?php echo $_v1['name'];?></a> 
                              <?php } }?>
