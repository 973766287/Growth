...
<li<?php echo $add_time;?>><a href="javascript:void(0)" rel="nofollow" onclick="clearstyle('goods_id');get_categoods_page_lists('1','<? echo $rt['suppId'];?>','<?php echo $rt['thiscid'];?>','<?php echo $rt['thisbid'];?>','<?php echo $rt['price'];?>','goods_id','<?php echo $rt['sort']=='DESC' ? 'ASC' : 'DESC';?>','<?php echo $rt['limit'];?>','<?php echo $rt['thisattr'];?>')">默认</a></li>
		<li<?php echo $is_new;?>><a href="javascript:void(0)" rel="nofollow" onclick="clearstyle('is_new');get_categoods_page_lists('1','<? echo $rt['suppId'];?>','<?php echo $rt['thiscid'];?>','<?php echo $rt['thisbid'];?>','<?php echo $rt['price'];?>','is_new','<?php echo $rt['sort']=='DESC' ? 'ASC' : 'DESC';?>','<?php echo $rt['limit'];?>','<?php echo $rt['thisattr'];?>')">新款</a></li>
		<li<?php echo $sale_count;?>><a href="javascript:void(0)" rel="nofollow" onclick="clearstyle('sale_count');get_categoods_page_lists('1','<? echo $rt['suppId'];?>','<?php echo $rt['thiscid'];?>','<?php echo $rt['thisbid'];?>','<?php echo $rt['price'];?>','sale_count','<?php echo $rt['sort']=='DESC' ? 'ASC' : 'DESC';?>','<?php echo $rt['limit'];?>','<?php echo $rt['thisattr'];?>')">销量</a></li>
		<li<?php echo $pifa_price;?>><a href="javascript:void(0)" rel="nofollow" onclick="clearstyle('pifa_price');get_categoods_page_lists('1','<? echo $rt['suppId'];?>','<?php echo $rt['thiscid'];?>','<?php echo $rt['thisbid'];?>','<?php echo $rt['price'];?>','pifa_price','<?php echo $rt['sort']=='DESC' ? 'ASC' : 'DESC';?>','<?php echo $rt['limit'];?>','<?php echo $rt['thisattr'];?>')">价格</a></li>
