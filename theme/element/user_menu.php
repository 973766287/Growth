<div class="m_left user_menu">
	<div class="left_content">
		...
		<h2><a href="<?php echo SITE_URL.'user.php?act=mybuy&sale=yes'?>">我要订购</a></h2>
		<h2><a href="<?php echo SITE_URL.'user.php?act=myorder'?>">我的订单</a></h2>
		<h2><a href="<?php echo SITE_URL.'user.php?act=returnordergoods'?>">退换货单</a></h2>
<!--		<h1><span>账户管理</span><b></b></h1>
		...
		<h2><a href="<?php echo SITE_URL.'user.php?act=inbox'?>">我的信箱</a></h2>
