...
<?php echo $this->meta();?>
<?php echo $this->css(array('style.css','style20160120.css','jquery.jslides.css'));?>
<?php
...
?>
<?php echo $this->js(array('jquery.min.js','jquery-1.8.0.min.js','jquery.jslidess.js','jquery.cookie.js','jquery.json-1.3.js','jquery_dialog.js','common.js','menu.js','goods.js','chat.js','mycart.js'));?>
<script type="text/javascript" src="themes/tpl/<? echo $mb;?>/images/ghs/js/index_002.js" charset="utf-8"></script>
<script type="text/javascript" src="themes/tpl/<? echo $mb;?>/images/ghs/js/index_003.js" charset="utf-8"></script>
...
?>
	<?php $this->element('top_supplier',array('lang'=>$lang,'keyword'=>$keyword,'catList'=>$catList,'rt'=>$rt,'mb'=>$mb,
	's_nav'=>$s_nav,'s_info'=>$s_info)); ?>
	<?php echo $this->content();?>
	
	<?php $this->element('footer',array('lang'=>$lang,'rt'=>$rt)); ?>
