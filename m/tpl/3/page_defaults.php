...
<div style=" position:relative;height:44px; line-height:44px; background:#2d1d44;  position:fixed; bottom:0px; left:0px; width:100%; z-index:9999">
	...
	<a href="<?php echo $urls;?>" style=" position:absolute; right:10px; top:10px; z-index:99; cursor:pointer; height:25px; line-height:25px; width:60px; border:1px solid #00761d;border-radius: 5px; text-align:center; color:#FFF"<?php echo $sub;?>><?php echo $but;?></a>
</div>