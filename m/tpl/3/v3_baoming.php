...
<style type="text/css">
    ...
    .pw{
        ...
        border-radius: 5px; margin-top:0.08rem;
    ...
    .word{width:100%;text-align:center; line-height:24px;font-size:0.3rem}
     .word a{display: inline-block;color:red;font-size:0.3rem}
</style>
            ...
            wx.uploadImage({
                ...
                success: function (res) {
                    ...
                    $.post(SITE_URL + 'bm.php?act=uploadimg', {did: id, imgid: res.serverId}, function (txt) {
                        if (txt == -1) {
                            alert("不支持类型");
                            $("#chooseImage" + id).removeClass('uploadImage_show');
                            $("#uploadImage" + id).addClass('uploadImage_show');
                        } else if (txt == -2) {
                            alert("图片太大");
                            $("#chooseImage" + id).removeClass('uploadImage_show');
                            $("#uploadImage" + id).addClass('uploadImage_show');
                            ...
                            $("#showImage" + id).attr("src", "<?php echo dirname(SITE_URL); ?>../" + txt);
...
<div class="giftinfo_ct">
    ...
    <?php
    echo $rt['pinfo']['description'];
    ?>
    <br/> 
    <div class="word">   <a href="<?php echo ADMIN_URL; ?>bm.php?act=baoming_word&id=<?php echo $rt['pinfo']['id'];?>"> 
            《金葵花商城<?php   echo $rt['pinfo']['title'];?>协议》全文 </a></div>
  <br/>   
...
<div class="footffont">
        ...
        <?php if ($rank != 1 and $rank <= $rt['pinfo']['rank_id']) {
            ...
            <table cellpadding="3" cellspacing="5" border="0" width="100%">
                <tr>
                 ...
                 <?php        }else{?>
                        ...
                        <a href="<?php echo ADMIN_URL; ?>bm.php?act=baoming&id=<?php echo $rt['pinfo']['id']+1; ?>" style="color:red">立即升级</a>
                 <?php } ?>
                    </td>    
                </tr>
                <?php if($hasgift){
                ...
                <?php
                  ...
                  <tr>
                    <td width="100%" align="center" style="text-align:center">
                        <a href="<?php echo ADMIN_URL; ?>user.php?act=giftlist&rank=<?php echo $rank;?>" style="color:red">您还未免费领取奖品，请前往领取！</a>
                    </td>
                </tr>
                <?php } ?>
            </table>
            ...
            <form id="ssumit" name="ssumit" method="post" action="<?php echo ADMIN_URL . 'bm.php?act=confirmpay'; ?>">
                <table cellpadding="3" cellspacing="5" border="0" width="100%">
                    ...
                    <tr>
                        <td width="100%" align="center" style="text-align:center">
                            <input placeholder="姓名" type="text" name="uname" style="width:80%; height:34px; line-height:normal; padding-left:35px; background:url(<?php echo $this->img('v8.png'); ?>) 5px center no-repeat #FFF; font-size:14px;background-size:26px;" class="pw pw2"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="100%" align="center" ><div  style="width:80%; height:34px; line-height:34px; padding-left:35px; text-align:left; background:url(<?php echo $this->img('v7.png'); ?>) 5px center no-repeat #FFF; font-size:14px;background-size:26px;" class="pw pw2" >
    ...
    <!--                <tr>
                    ...
                    <tr>
                        <td width="100%" align="center" style="text-align:center">
                            <input placeholder="身份证号码" type="text" name="cardcode" style="width:80%; height:34px; line-height:normal; padding-left:35px; background:url(<?php echo $this->img('v03.png'); ?>) 5px center no-repeat #FFF; font-size:14px;background-size:26px;" class="pw pw2"/>
                        </td>
                    </tr>
    <!--                <tr>
                        <td width="100%" align="center" style="text-align:center">
                    ...
                    <tr>
                        <td width="100%" align="center" style="text-align:center">
                            <input placeholder="手机号码" type="text" name="upne" style="width:80%; height:34px; line-height:normal; padding-left:35px;background-size:26px;background:url(<?php echo $this->img('v4.png'); ?>) 7px center no-repeat #FFF;font-size:14px;" class="pw pw2"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="100%" align="center" style="text-align:center">
                            <input placeholder="QQ号" type="text" name="qq" style="width:80%; height:34px; line-height:normal; padding-left:35px; background:url(<?php echo $this->img('v1.png'); ?>) 5px center no-repeat #FFF;background-size:26px; font-size:14px; " class="pw pw2"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="100%" align="center" style="text-align:center">
                            <input placeholder="微信号" type="text" name="weixin" style="width:80%; height:34px; line-height:normal; padding-left:35px; background:url(<?php echo $this->img('v2.png'); ?>) 5px center no-repeat #FFF; background-size:26px; font-size:14px;" class="pw pw2"/>
                        </td>
                    </tr>
                    <tr><td>	
                            <style>
...
<div class="show_zhuan" style=" display:none;width:100%; height:100%; position:fixed; top:px; right:0px; z-index:9999999;filter:alpha(opacity=90);-moz-opacity:0.9;opacity:0.9; background:url(<?php echo $this->img('gz/121.png'); ?>) right top no-repeat #000;background-size:100% auto;" onclick="$(this).hide();"></div>
<?php
