            ...
            <table cellpadding="3" cellspacing="5" border="0" width="100%">
                <tr>
                    <td width="100%" align="center" style="text-align:center">
                        ...
                        <a href="<?php echo ADMIN_URL; ?>bm.php?act=baoming&id=<?php echo $rt['pinfo']['id']+1; ?>" style="color:red">立即升级</>
                    </td>     </td>
                </tr>
                  <tr>
                    <td width="100%" align="center" style="text-align:center">
                        <a href="<?php echo ADMIN_URL; ?>user.php?act=giftlist&rank=<?php echo $rank;?>" style="color:red"> 如果您还未领取礼包，请前往领取-></a>
                    </td>
                </tr>
            </table>
            <?php
