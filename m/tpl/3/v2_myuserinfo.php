...
.uitem p.pp a span{border-radius:10px; height:24px; line-height:24px; padding-left:15px; padding-right:15px;display:block;background:#497bae; text-align:center; font-size:12px; font-weight:bold; color:#B70000; cursor:pointer; position:absolute;right:10%; top:8px; z-index:99;}
</style>
...
<div style="min-height:300px; padding-bottom:10px;" class="ucenter">
	...
	<ul>
  	...
  	<div data-role="content" class="ui-content" role="main">
		<div class="uitem">
			<p class="pp">
				<a href="javascript:;" onclick="ajax_show_sub(1,this);"><i></i>他的一级会员<span><?php echo empty($rt['zcount1']) ? '0' : $rt['zcount1'];?>人</span></a>
			</p>
<!--			<ul class="gonglist gg1">
		...
		<div class="uitem">
			<p class="pp">
				<a href="javascript:;" onclick="ajax_show_sub(2,this);"><i></i>他的二级会员<span><?php echo empty($rt['zcount2']) ? '0' : $rt['zcount2'];?>人</span></a>
			</p>
<!--			<ul class="gonglist gg2">
		...
		<div class="uitem">
			<p class="pp">
				<a href="javascript:;" onclick="ajax_show_sub(3,this);"><i></i>他的三级会员<span><?php echo empty($rt['zcount3']) ? '0' : $rt['zcount3'];?>人</span></a>
			</p>
