...
<div id="main" style="min-height:300px">
	...
	<form name="USERINFO2" id="USERINFO2" action="" method="post">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="line-height:30px;">
                     <tr>
			<td  align="center" style="padding-bottom:2px;" colspan="2">带*为必填项  </td>
		  </tr>
                     <tr>
			...
			<td width="75%" align="left" style="padding-bottom:2px;">
                        <input type="radio" value="1" name="gender"  id="gender1"  <?php if($rts['gender']==1){echo "checked";} ?>  />男
                        <input type="radio" value="2" name="gender"  id="gender2"  <?php if($rts['gender']==2){echo "checked";} ?> />女
                        </td>
		  </tr>
                    <tr>
		   ...
		   <tr>
			...
			<input type="text" value="<?php echo isset($rts['banksn']) ? $rts['banksn'] : '';?>" name="banksn"  class="pw"/></td>
                   ...
                   <tr>
			<td width="25%" align="right" style="padding-bottom:2px;"><b class="cr2">*</b> 身份证号：</td>
			<td width="75%" align="left" style="padding-bottom:2px;">
			<input type="text" value="<?php echo isset($rts['idcard']) ? $rts['idcard'] : '';?>" name="idcard"  class="pw"/></td>
		  </tr>
		   <tr>
...
<!--                     <tr>
			...
			<td width="75%" align="left" style="padding-bottom:2px;">
			<input type="text" value="<?php echo isset($rts['alipay']) ? $rts['alipay'] : '';?>" name="alipay"  class="pw"/></td>
		  </tr>-->
<!--                     <tr>
			<td width="25%" align="right" style="padding-bottom:2px;">  微信钱包：</td>
			<td width="75%" align="left" style="padding-bottom:2px;">
			<input type="text" value="<?php echo isset($rts['weixin']) ? $rts['weixin'] : '';?>" name="weixin"  class="pw"/></td>
		  </tr>-->
		  <tr>
...
function update_user_bank(){
	...
	if( (banknames=="" || unames=="" || banksns=="") &&idcard==''){
	...
	if(confirm('确认修改吗')){
		...
		$.post('<?php echo ADMIN_URL;?>daili.php',{action:'update_user_bank',bankname:banknames,bankaddress:bankaddresss,uname:unames,banksn:banksns,alipay:alipay,idcard:idcard,gender:gender},function(data){ 
