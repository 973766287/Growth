...
<div class="registrationBox">
	<div class="registration">
        <div id="reg_name">
            <span class="bBor">
            <input placeholder="请输入您的昵称" type="text" id="nickname">
            </span>
        </div>
    	<div id="reg_name">
        	<span class="bBor">
        ...
        <div id="reg_password">
        	<span class="bBor">
            <input placeholder="请输入密码" id="password" type="text">
            </span>
        </div>
        <div id="reg_code">
        	<span class="bBor">
        ...
        <div id="reg_sub"><input value="立即注册" type="submit"></div>
    </div>
    <div id="loginBg"></div>
</div>
<script type="text/javascript">
    ...
    $("#reg_sub").click(function(){
        ...
        var parent_uid = <?php echo !empty($parent_uid)?$parent_uid:0;?>;
        ...
        $.post("<?php echo ADMIN_URL;?>user.php?act=user_register&data="+encodeURIComponent(json_str),function(data){
