...
<div id="main" style="min-height:300px">
  ...
  <!--  <input type="hidden" name="action" value="postmoney"/>-->
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" style="line-height:30px;">
		  ...
		  <tr>
			...
			<a id="next" href="javascript:;" onclick="postmoney();" style="border-radius:5px;display:block;background:#3083CE;cursor:pointer;width:140px; height:25px; line-height:25px; font-size:14px; color:#FFF">确认提交</a><span class="returnmes2" style="padding-left:10px; color:#FF0000"></span>
			</td>
		  </tr>
		</table>
	</form>
