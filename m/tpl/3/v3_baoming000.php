...
<div class="giftinfo_bt"><input style=" margin-left:0.1rem;" type="checkbox" id="select_all"  hidefocus="true" checked="checked"><label class="oauth_item_title" for="select_all">我已阅读并知晓<span>《金葵花商城使用协议》</span></label></div>
</div>
<div class="footffont">
