...
<div id="main" style="padding:5px; padding-top:0px; min-height:300px">
	...
	if ($orderinfo){
	foreach($orderinfo as $k => $rows){
		
		?>
    <tr><td></td><td>订单：<? echo $rows['order_sn'];?></td></tr>
		...
		<tr>
			...
			<p style="padding-top:5px; padding-left:10px; font-size:14px;">支付方式：<?php echo $pay_name;?></p>
		...
		<div>
           ...
           <? if($dds == 1){?>
			<a href="<?php echo ADMIN_URL.'mycart.php?type=fastpay2&oid='.$oid;?>" class="btn-buy button ui-btn ui-btn-text-only"><span class="ui-btn-text">立即支付</span></a>
            <? }else{?>
            <a href="<?php echo ADMIN_URL;?>user.php?act=myorder" class="btn-buy button ui-btn ui-btn-text-only"><span class="ui-btn-text">立即支付</span></a>
           <? }?>
