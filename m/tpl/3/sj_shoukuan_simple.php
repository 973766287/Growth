...
<h4 style="color:#ff002c;padding:3%;font-size:14px;line-height:30px;">温馨提示：谨防“兼职刷单”、“高额返利”、“培训”、“话费充值”、“刷信誉”、“套现”等付款骗局！</h4>
<div class="cashier_order" style="padding:3%;">



 <h3 style="padding: 10px;">店铺名称:<? echo $shop;?></h3>
</div>
...
<input name="openid"  id="openid" value="<? echo $rr['openid'];?>" type="hidden">

<input name="supplier_id"  id="supplier_id" value="<? echo $uid;?>" type="hidden">
