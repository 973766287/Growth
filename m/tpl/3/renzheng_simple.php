...
<dl>
  ...
  <dl>
   ...
   <dd><input name="name" id="name"   type="text"  value="<?php  echo $rts['uname'];?>" <?php if(!empty($rts['uname'])){?>readonly="readonly"<?php }?>  placeholder="中文姓名"></dd>
...
<script>
    ...
    if(iSum%11!=1){
		...
		$.post('<?php echo ADMIN_URL;?>daili.php',{action:'update_user_bank_simple',shop_name:shop_name,address:address,name:name,card_no:card_no,bank_no:bank_no,bank_code:bank_code,mobile:mobile,yz_code:yz_code},function(data){ 
