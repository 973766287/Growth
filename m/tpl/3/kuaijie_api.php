...
<? if(!empty($rt['respCode']) && $rt['respCode']=='000000' ){?>
	<form name="myform" id="myform" action="<?php echo ADMIN_URL;?>mycart.php?type=kj_confirm_api" method="post">
...
<script>
 $('#getcode').click(function () {
	...
	$.post('<?php echo ADMIN_URL;?>mycart.php',{action:'getcode_api',uid:uid,oriReqMsgId:oriReqMsgId,merchantId:merchantId,pay_address:pay_address},function(data){ 
