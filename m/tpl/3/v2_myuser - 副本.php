...
<div id="main" style="min-height:300px;margin-bottom:20px;">
	...
	<?php if(!empty($rt['lists']))foreach($rt['lists'] as $k=>$row){?>
		<li style="padding:5px; border-bottom:1px solid #d8d8d8; position:relative">
			...
			<p style="line-height:23px">资金&nbsp;<font color="#FF0000">￥<?php echo $row['money_ucount'];?></font>&nbsp;|&nbsp;积分&nbsp;<font color="#FF0000"><?php echo $row['points_ucount'];?></font>&nbsp;|&nbsp;邀请&nbsp;<font color="#FF0000"><?php echo $row['share_ucount'];?></font></p>
			                        <p style="line-height:23px">等级&nbsp;<font color="#FF0000"><?php echo $row['level_name'];?></font>&nbsp;</p>
                        </div>
			<div class="clear"></div>
			</a>
