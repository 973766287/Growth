                ...
                foreach ($rt['userress'] as $row) { ?>
                    <tr style="border-bottom:1px solid #e6e6e6;">
                        <td style="border-top:1px solid #e6e6e6; line-height:0.6rem; padding-top:0.1rem; margin-top:0.05rem; padding-bottom:0.2rem;">
                            <label style="padding-left:10px;"><input<?php echo $row['is_default'] == '1' ? ' checked="checked"' : ''; ?> type="checkbox" class="showaddress" name="userress_id" value="<?php echo $row['address_id']; ?>"/>
                                <?php
