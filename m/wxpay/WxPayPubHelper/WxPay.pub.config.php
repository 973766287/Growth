...
$pay = $app->action('shopping','_get_payinfo',2);
...
define('apiclient_cert',SYS_PATH_WAP.'wxpay/WxPayPubHelper/cacert/apiclient_cert.pem');
define('apiclient_key',SYS_PATH_WAP.'wxpay/WxPayPubHelper/cacert/apiclient_key.pem');
