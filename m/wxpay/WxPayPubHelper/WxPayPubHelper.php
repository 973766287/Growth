...
class Common_util_pub
{
	...
	public function getSign($Obj)
	{
		...
		//签名步骤二：在string后加入KEY
		$String = $String."&key=kReLRqg88K4fg90e69lbnR5mP4PB0bl8";
	...
	function createXml()
	{
		try
		{
			...
			if($this->parameters["out_trade_no"] == null) 
			{
		   	...
		   	$this->parameters["appid"] = wxec249a83c2981248;//公众账号ID
		   	$this->parameters["mch_id"] = 1498289052;//商户号
...
class JsApi_pub extends Common_util_pub
{
	...
	{
		$jsApiObj["appId"] = wxec249a83c2981248;
		$timeStamp = time();
