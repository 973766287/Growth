...
function set_account(t){
	   ...
	   urls = t==1 ? SITE_URL+"user.php?action=set_account_save" : "";
...
function bd_account(t){
	   ...
	   urls = t==1 ? SITE_URL+"user.php?action=bd_account_save" : "";
...
function update_user_shop(t){
	   ...
	   urls = t==1 ? SITE_URL+"user.php?action=updateshop" : SITE_URL+"daili.php?action=ajax_updateshop";
